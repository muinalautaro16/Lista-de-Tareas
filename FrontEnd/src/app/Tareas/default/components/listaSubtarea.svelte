...
<class class="columns margins">
        ...
        {#each etapas as etapa}
            <div style="display:flex">
                <Item>
                    <Meta>
                        <Checkbox
                            ...
                            bind:checked={etapa.estado}
                        />
                    </Meta>
                    {#if etapa.estado}
                        <Textfield
                            bind:value={etapa.nombre}
                ...
                <IconButton
                    ...
                    aria-label="Trash"
                    on:click={() => eliminarEtapa(etapa.id)}>delete</IconButton
                >
            </div>
        {/each}
    </List>
    ...
    <div style="display: flex;">
        <Button
            style="color:white; margin:2.5vh; margin-left:0vh;"
            on:click={() => crearEtapa(valueA)}
        >
