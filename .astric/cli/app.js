...
const folderFront = './FrontEnd/src/app/';
...
async function copy(from, to) {
    try {
        ...
        console.log('DIRECTORIO DE APP EN FRONTEND:', folderCLI + from, folderFront + to)
        ...
        if (separatorApp.search(to) < 0) {
            ...
            if (app) {
                ...
                separatorApp.splice(separatorApp[0], 1, `${separatorApp[0]}import ${to} from '${folderFront + to}/main.svelte';</script>`);
                ...
                separatorMod.splice(separatorMod[1], 1, `${separatorMod[0]}const routes = { '/${newTo[1]}': wrap({ asyncComponent: () => import('./${newTo[1]}/Modul.svelte') }),`);
